var ENTITY_URL_LIST = "/bx/bxck/bxck";
var PAGESIZE=20;
/*
 * 报修查看
 * @author chenhui
...
LookForm = Ext.extend(Ext.ux.Form, {
    constructor: function() {
	    ...
	    this.myd = this.createTextField('满意度','myd','95%','95%',null,100,'长度超过不能100');
...
TxGlpzGrid = Ext.extend(UxGrid,{
	    ...
	    constructor: function(height, width){
	    	...
	    	this.store = new Ext.data.Store({          //Grid Store
	    		proxy: new Ext.data.HttpProxy({url:PATHNAME+""+ENTITY_URL_LIST,method:'POST'}),
...
//				                        store.insert(0,rs);
	        ...
	        TxGlpzGrid.superclass.constructor.call(this, {
	            ...
	            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
	                    		            ...
	                    		            {header:'报修编号',dataIndex:'bxbh',width:210,sortable:true,hidden:false},
	                    		            {header:'申请人姓名',dataIndex:'sqrxm',width:100,sortable:true,hidden:false},
	                    		            {header:'楼宇',dataIndex:'ly',width:180,sortable:true,hidden:false},
	                    		            ...
	                    		            /*{header:'满意度',dataIndex:'myd',width:100,sortable:true,hidden:false,
	                    		            ...
	                    		            {header:'内容',dataIndex:'nr',width:230,sortable:true,hidden:false,
	                    		            ...
	                    		            {header:'预约时间',dataIndex:'yysj',width:110,sortable:true,hidden:false},
	                    		            {header:'状态',dataIndex:'ztbh',width:80,sortable:true,hidden:false,
	                    		            	renderer:function(value){
	                    		                    if(value == '1') {
