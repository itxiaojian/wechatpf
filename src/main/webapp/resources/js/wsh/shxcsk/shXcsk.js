...
ConstructionForm = Ext.extend(Ext.ux.Form, {
    ...
    constructor: function() {
        ...
        this.rq = this.createDateTimeField('<font color="red">*</font>日期:', 'rq', 'H:i','85%');
        this.cfsj = this.createDateTimeField('<font color="red">*</font>出发时间:', 'cfsj', 'H:i','出发时间不能为空！');
        //this.cfd = this.createTextField('出发地:', 'cfd', '85%','出发地不能为空！');
        this.cfd = this.createTextField('出发地:', 'cfd', '85%','出发地不能为空！');
        this.mdd = this.createTextField('<font color="red">*</font>目的地:', 'mdd', '85%','目的地不能为空！');
       // this.fbr = this.createTextField('发布人:', 'fbr', '85%','发布人不能为空！');
      // this.fbrxm = this.createTextField('发布人姓名:', 'fbrxm', '85%','发布人姓名不能为空！');
        this.zt = this.createTextField('状态:', 'zt', '85%','状态不能为空！');
   //    this.fbr.allowBlank = true;
   //    this.fbrxm.allowBlank = true;
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
                            {name:'id'},{name:'cph'},{name:'rq'},{name:'cfsj'},{name:'cfd'},{name:'mdd'}, {name:'zt'}
            ])
        });
