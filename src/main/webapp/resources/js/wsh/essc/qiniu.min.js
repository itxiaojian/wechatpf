        ...
        return j.bind("Init", function() {
            ...
            var e = function(c, d, e) {
                    ...
                    if (void 0 !== g && "object" == typeof g)
                        for (var h in g) g.hasOwnProperty(h) && ("function" == typeof g[h] ? f["x:" + h] = g[h](c, d) : "object" != typeof g[h] && (f["x:" + h] = g[h]));
                    c.setOption({
                        url: "http://up.qiniu.com/",
                        multipart: !0,
                        chunk_size: void 0,
            ...
            if (g = g || c.settings && c.settings.chunk_size, "html5" === j.runtime && g)
                if (d.size < g) e(c, d, a.key_handler);
                else {
