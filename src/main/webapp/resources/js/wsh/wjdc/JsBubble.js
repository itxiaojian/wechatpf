function JsBubble(){
		  ...
		  JsBubble.prototype ={
				 ...
				 addCon:function(Tinfo){
					 ...
					 if(Tinfo.Close){
					     $Close = $('<a href="javascript:;" class="jsTip_close">X</a>');
						 Cpar = 0;
						 $title='<div class="tipTitle" style="background:'+Tinfo.TBaColor+';border-bottom:1px solid'+Tinfo.TBoColor+';">'+Tinfo.title+'</div>';
					 }
					 
					 var $con = $('<div id="'+this.Tinfo.id+'" class="jsBubble_s" style="width:'+Tinfo.width+';left:'+Tinfo.left+'px; top:'+Tinfo.top+'px;">'+
