var USER_GRID_STORE_URL = 'getSbsgCwspList';
var PAGESIZE=20;
...
ConstructionForm = Ext.extend(Ext.ux.Form, {
    ...
    this.spyj.allowBlank = false;
     ...
     addFormClick: function() {
    		...
    		//console.info(records[0].data.sbmc);
            if(this.getForm().isValid()) {
         	this.getForm().submit({
                 ...
                 method: 'GET',
                 params:{
                	 sbmc : records[0].data.sybm,
                	 sbxh : records[0].data.sbxh,
                	 cgsl : records[0].data.cgsl,
                	 sblb : records[0].data.sblb,
                	 sccj : records[0].data.sccj,
                	 bmmc : records[0].data.bmmc,
                	 sybm: records[0].data.sybm,
                	 xm : records[0].data.xm,
                	 sgr : records[0].data.sgr,
                	 sgrq : records[0].data.sgrq
                 },
                 success: function() { 
...
//        });    	
        ...
        ConstructionGrid.superclass.constructor.call(this, {
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
                                      	...
                                      	{header:'规格型号',dataIndex:'sbxh',width:120,align:'center',sortable: true},
                                      	{header:'数量',dataIndex:'cgsl',width:60,align:'center',sortable: true},
                                      	...
                                      	{header:'申请人',dataIndex:'xm',width:80,align:'center',sortable: true},
                                      	{header:'申请人',dataIndex:'sgr',width:120,align:'center',sortable: true,hidden:true},
                                      	{header:'申请日期',dataIndex:'sgrq',width:80,align:'center',sortable: true},
                                      	{header:'申请状态',dataIndex:'sgzt',width:90,align:'center',sortable: true},
                                      	{header:'申批人姓名',dataIndex:'sprxm',width:80,align:'center',sortable: true},
