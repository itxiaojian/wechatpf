    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
            		...
            		,{name:'tcrxm'},{name:'bmmc'},{name:'bmbh'},{name:'zt'},{name:'tclx'},
            ])
        });
    	this.vbbar= this.createPagingToolbar(PAGESIZE);
    	this.vtbar = new Ext.Toolbar({
            items:[
				'-',{xtype:'label',text:'吐槽类型：'},{xtype:'combo',id:'tclx',
					   editable: false,
				...
				'-',{xtype:'button',text:'查询',iconCls:'query',handler:function(){
		       			var params = {};
		       			params['tclx']=Ext.getCmp('tclx').getValue();
...
//            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true},
            	...
            	{header:'类型',dataIndex:'tclx',width:200,sortable: true,
            		renderer:function(value){
	                    if(value == '1') {
	                        return "<span style='color:blue;'>我的吐槽</span>";
	                    }else if(value == '2') {
	                        return "<span style='color:fuchsia;'>表白墙</span>";
	                    }else {
	                    	return value;
	                    }
            		}
