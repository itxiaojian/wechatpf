var USER_GRID_STORE_URL = 'getPjxx';
var PAGESIZE=20;
...
ConstructionForm = Ext.extend(Ext.ux.Form, {
    ...
    constructor: function() {
    	...
    	this.xh = this.createTextField('<font color="red">*</font>序号:', 'xh', '85%','序号不能为空！');
    	this.jsgh = this.createTextField('<font color="red">*</font>教师工号:', 'jsgh', '50%','教师工号不能为空！');
        this.jsxm = this.createTextField('<font color="red">*</font>教师姓名:', 'jsxm', '85%','教师姓名不能为空！');
        this.rjkm = this.createTextField('<font color="red">*</font>任教科目:', 'rjkm', '85%','任教科目不能为空！');
        //this.tjsj = this.createDateField('<font color="red">*</font>添加时间:', 'tjsj', 'y-m-d','添加时间不能为空！');
        
        var tjsj =  new Ext.form.DateField({
			fieldLabel: "添加时间",
			name: "tjsj",
			format: "Y-m-d",
			anchor: "添加时间不能为空",
        ...
        this.ksxn = this.createTextField('<font color="red">*</font>评教学年:', 'ksxn', '85%','评教学年不能为空！');
        this.ksxq = this.createTextField('<font color="red">*</font>评教学期:', 'ksxq', '85%','评教学期不能为空！');
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({totalProperty: 'total', root:'rows'},[
                           {name:'id'},{name:'xh'},{name:'jsgh'},{name:'jsxm'},
                           {name:'rjkm'},{name:'tjsj'},{name:'ksxn'},{name:'ksxq'},
                           {name:'zt'},{name:'bz'}
            ])
        });
...
//            	{header:'新闻标题',dataIndex:'xwbt',width:200,sortable: true},
            	...
            	*/
                {header:'序号',dataIndex:'xh',width:80,sortable: true},
            	{header:'教师工号',dataIndex:'jsgh',width:80,sortable: true},
            	{header:'教师姓名',dataIndex:'jsxm',width:80,sortable: true, },
            	{header:'任教科目',dataIndex:'rjkm',width:80,sortable: true},
            	{header:'添加时间',dataIndex:'tjsj',width:80,sortable: true},
            	{header:'备注',dataIndex:'bz',width:80,sortable: true, },
            	{header:'评教学年',dataIndex:'ksxn',width:80,sortable: true},
            	{header:'评教学期',dataIndex:'ksxq',width:80,sortable: true},
            	{header:'状态',dataIndex:'zt',width:80,sortable: true, }
            ]),
            tbar: this.vtbar,
            bbar: this.vbbar,
            ds: this.store,
