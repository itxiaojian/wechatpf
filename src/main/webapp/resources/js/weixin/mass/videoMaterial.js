...
var ENTITY_URL_UPLOAD = "/wxauth/materialmgr/uploadVideo";
...
MyUploadForm = Ext.extend(Ext.ux.Form,{
	constructor: function(){
		this.tishi = new Ext.form.DisplayField({
			value:'<span  style="color:red;font-weight:bold;">视频大小10MB，支持MP4格式</span>'
		});
	...
	onUploadClick: function(){
		if(this.getForm().isValid()){
        	...
        	if(attachmentType != "mp4" ){
        		Ext.MessageBox.alert("系统提示:", BLANKSTR + "视频类型为MP4" + BLANKSTR);
        		return;
        	}
...
UnteckAttachmentGrid = Ext.extend(UxGrid,{
	constructor: function(height,width){
		...
		this.vtbar = new Ext.Toolbar({
			items: [
					'-',{xtype:'button',text:'上传视频',iconCls:'db-icn-upload',handler:this.onUploadClick,scope:this},
