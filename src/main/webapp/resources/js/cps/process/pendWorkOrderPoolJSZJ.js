//需要补充的空格
var BLANKSTR = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';   
var PENDPOOL_GRID_STORE_URL = 'getPendPoolListJSZJ';
var PAGESIZE=20;
//环节处理窗口全局变量
var ACT_DEAL_WINDOW;
/**************************PendPoolGrid*******************************************/
PendPoolGrid = Ext.extend(UxGrid, {
    ...
    constructor: function(height, width){
    	this.store = new Ext.data.Store({          //Grid Store
            ...
            reader: new Ext.data.JsonReader({fields:[
            		...
            		{name:'createTime'},{name:'dueDate'},{name:'description'},{name:'pid'},{name:'pname'}
            		,{name:'processCode'},{name:'processStatus'},{name:'procInstId'},{name:'businessKey'}
            ]})
        });
        ...
        //	title: '待办任务列表',
            ...
            cm: new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),
               ...
               {header:'操作',dataIndex:'assignee',width:60,sortable: true,
                ...
                {header:'流程编号',dataIndex:'processCode',width:100,sortable: true},     
                {header:'流程名称',dataIndex:'pname',width:200,sortable: true},                
    ...
    dealTask: function() {//处理任务
    	...
    	var url = "openTaskDealPage/" + taskId + "/" + businessKey;   	
