...
(function() {
    ...
    d.range = function(l) {
        ...
        function o(u) {
            ...
            return function(y) {
                ...
                } else if (y.type == 1) if (!n[y.getName()]) if (!c && y.is('br') && !v && !(u && y.getNext())) v = true;
                else return false;
                return true;
            };
        };
    ...
    //add by liuxiantao 20141218
    j.add('attachment', {
        requires: ['dialog'],
        init: function(m) {
            var n = m.addCommand('attachment', new a.dialogCommand('attachment'));
            n.modes = {
                wysiwyg: 1,
                source: 1
            };
            n.canUndo = false;
            n.readOnly = 1;
            m.ui.addButton('Attachment', {
                label: "附件选择",
                command: 'attachment',
                icon: this.path + 'images/attachment.png'
            });
            a.dialog.add('attachment', this.path + 'dialogs/attachment.js');
        }
    });
    //----------------------------------
    j.add('about', {
    ...
    a.DIALOG_RESIZE_BOTH = 3; (function() {
        ...
        a.dialog.prototype = {
            ...
            addPage: function(Q) {
                ...
                ac._.tabs[Q.id] = [Y, V];
                ac._.tabIdList.push(Q.id); ! Q.hidden && ac._.pageCount++;
                ac._.lastTab = Y;
                ac.updateStyle();
        ...
        P = function(Q, R) {}; (function() {
            k.dialog = {
                uiElement: function(Q, R, S, T, U, V, W) {
                    ...
                    Y.push('>', ab, '</', X, '>');
                    S.push(Y.join('')); (this._ || (this._ = {})).dialog = Q;
                    if (typeof R.isChanged == 'boolean') this.isChanged = function() {
                        return R.isChanged;
                    };
                    if (typeof R.isChanged == 'function') this.isChanged = R.isChanged;
                    if (typeof R.setValue == 'function') this.setValue = e.override(this.setValue,
                    function(al) {
                        return function(am) {
                            al.call(this, R.setValue.call(this, am));
                        };
                    });
                    if (typeof R.getValue == 'function') this.getValue = e.override(this.getValue,
                    function(al) {
                        return function() {
        ...
        k.dialog.uiElement.prototype = {
            ...
            setValue: function(Q, R) {
                this.getInputElement().setValue(Q); ! R && this.fire('change', {
                    value: Q
                });
                return this;
            },
    ...
    i.editingBlock = true; (function() {
        ...
        j.add('selection', {
            init: function(z) {
                ...
                z.selectionChange = function(E) { (E ? m: p).call(this);
                };
