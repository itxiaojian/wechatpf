...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/zs/Txkg.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="提醒开关配置">
	<a href="<%=path%>/wtx/Txkg/index" target="content" onfocus="this.blur()"><span>提醒开关配置</span></a>
	</li>
</ul>
</div>
</body>
