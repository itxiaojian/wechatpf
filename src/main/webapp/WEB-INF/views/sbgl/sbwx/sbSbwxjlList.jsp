...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/weixin_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbwx/sbSbwxjl.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备维修记录"><a
				href="<%=path%>/sbgl/SbSbwxjl/SbwxjlPage" target="content"
				onfocus="this.blur()"><span>设备维修记录</span></a></li>
		</ul>
	</div>
