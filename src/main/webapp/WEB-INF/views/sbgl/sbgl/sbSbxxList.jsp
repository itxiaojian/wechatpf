...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/weixin_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbgl/sbSbxx.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备管理"><a
				href="<%=path%>/sb/sbSbxx/sbxxPage" target="content"
				onfocus="this.blur()"><span>设备管理</span></a></li>
		</ul>
	</div>
