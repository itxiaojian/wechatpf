...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbjcxx/sbSbjcxx.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备借出信息"><a
				href="<%=path%>/sbgl/SbSbjcxx/SbjcxxPage" target="content"
				onfocus="this.blur()"><span>设备借出信息</span></a></li>
		</ul>
	</div>
