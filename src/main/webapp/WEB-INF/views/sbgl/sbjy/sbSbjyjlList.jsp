...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbjy/sbSbjyjl.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备检验记录"><a
				href="<%=path%>/sbgl/SbSbjyjl/SbjyjlPage" target="content"
				onfocus="this.blur()"><span>设备检验记录</span></a></li>
		</ul>
	</div>
