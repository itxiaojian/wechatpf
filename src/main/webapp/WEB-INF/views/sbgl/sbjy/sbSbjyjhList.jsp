...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbjy/sbSbjyjh.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备检验计划"><a
				href="<%=path%>/sbgl/SbSbjyjh/SbjyjhPage" target="content"
				onfocus="this.blur()"><span>设备检验计划</span></a></li>
		</ul>
	</div>
