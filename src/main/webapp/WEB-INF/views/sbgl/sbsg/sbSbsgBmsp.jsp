...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbsg/sbSbsgBmsp.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/sbgl/SbSbjyjh/SbjyjhPage" target="content" onfocus="this.blur()"><span>设备申购</span></a>
	</li>
</ul>
</div>
