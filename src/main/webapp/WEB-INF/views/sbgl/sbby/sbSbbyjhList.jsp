...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/weixin_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sbgl/sbby/sbSbbyjh.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="设备保养计划"><a
				href="<%=path%>/sbgl/SbSbbyjh/SbbyjhPage" target="content"
				onfocus="this.blur()"><span>设备保养计划</span></a></li>
		</ul>
	</div>
