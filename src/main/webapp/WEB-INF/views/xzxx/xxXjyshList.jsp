...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/xzxx/xxXjysh.js"></script>
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="信件已审核"><a
				href="<%=path%>/xzxx/XxXjxxb/xjyshPage" target="content"
				onfocus="this.blur()"><span>信件已审核</span></a></li>
		</ul>
	</div>
