                    ...
                    <div class="mail-body">
                        ...
                        <form class="form-horizontal" id="mForm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="xjbt" id="xjbt" validate="require;maxlength(32)">
                                </div>
                            </div>
                            <div class="form-group">
...
<!--                                     <input type="text" class="form-control" value=""> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="txdz" id="txdz" validate="require;maxlength(30)">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="lxdh" id="lxdh" validate="require;maxlength(11)">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <div class="col-sm-10">
                                    <textarea  class="form-control" id="xjnr" name="xjnr" cols="10" rows="4" > </textarea>
                                </div>
                            </div>
                        </form>
