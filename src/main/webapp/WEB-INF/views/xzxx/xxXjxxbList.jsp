...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/xzxx/xxXjxxb.js"></script>
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="信件信息表"><a
				href="<%=path%>/xzxx/XxXjxxb/xjxxbPage" target="content"
				onfocus="this.blur()"><span>信件信息表</span></a></li>
		</ul>
	</div>
