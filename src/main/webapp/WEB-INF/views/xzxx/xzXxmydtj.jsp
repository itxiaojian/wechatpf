...
.bordered tr:last-child td:last-child {
    ...
    function showECharts(){
    	var starttime= $('#starttimeInput').val();
		 ...
		 var html="";
		  $.ajax({
				url :'<%=path%>/xzxx/XxXjxxb/getXzyxmydtjt',
				data : {
					     id:lx,
						 stime:starttime,
						 etime:endtime,
        ...
        $.ajax({
			  type: 'get',
			  url: '<%=path%>/xzxx/XxXjxxb/getXzyxmydtjb',
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="校长邮箱满意度统计"><a
				href="<%=path%>/xzxx/XxXjxxb/toXzyxmydPage" target="content"
				onfocus="this.blur()"><span>校长邮箱满意度统计</span></a></li>
		</ul>
	</div>
		<div id="table"
		...
		<table class="bordered">
			<thead id="thead">
				<tr>
					...
					<td height="20" style="width: 305px;">部门</td>
					<td height="20" style="width: 305px;">非常满意</td>
					<td height="20" style="width: 305px;">满意</td>
					<td height="20" style="width: 305px;">不满意</td>
				</tr>
			</thead>
			<tbody id="list">
