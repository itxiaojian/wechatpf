...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/xzxx/xxXjysl.js"></script>
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="信件已受理"><a
				href="<%=path%>/xzxx/XxXjxxb/xjyslPage" target="content"
				onfocus="this.blur()"><span>信件已受理</span></a></li>
		</ul>
	</div>
