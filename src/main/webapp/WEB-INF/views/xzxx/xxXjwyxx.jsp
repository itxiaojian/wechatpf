...
<script type="text/javascript">
	...
	function Submit(){
	   ...
	   if(isMob.test(s)||isPhone.test(s)){my=true}
		...
		$('#addInput').hide();
		//$('#addInput').disable();
		var url = '<%=path%>/xzxx/XxXjxxb/saveWyxx';
		...
		$.ajax({
			...
			success: function(data){
				if(data != '' && data =='1'){
					location.href ="<%=path%>/xzxx/XxXjxxb/getXjmhckList";
				}else if(data=='2'){
...
<div>
		<div style="display: none;">
			<ul class="tab-menu tab" id="tabMenuID_">
				<li class="tab-selected" title="我要写信"><a
					href="<%=path%>/xzxx/XxXjxxb/wyxx" target="content"
					onfocus="this.blur()"><span>我要写信</span></a></li>
			</ul>
		</div>
<div class="style2">
...
维护， 请使用<a href="http://wx.wxc.edu.cn:8080/wxpt/bx/bxck/cklist">报修系统</a></div>
		<div class="margin1">
		
			<div class="text1"><span style="color:red;">*</span>信件标题：</div>
			<input type="text" class="input2 wwx_f_l" name="xjbt" id="xjbt" validatelabel="信件标题" validate="require;maxlength(32)">
			<div class="wwx_clear"></div>
		</div>
		<div class="margin1">
			<div class="text1">受理部门：</div>
<!-- 			<input type="text" class="input2 wwx_f_l" name="slbmbh" id="slbmbh" validatelabel="受理部门" validate="require;maxlength(200)"> -->
		...
		<div class="margin1">
			...
			<input type="text" class="input2 wwx_f_l" name="txdz" id="txdz"  validatelabel="电子邮箱" validate="require;maxlength(30)">
			<div class="wwx_clear"></div>
		</div>
		<div class="margin1">
			<div class="text1">联系电话：</div>
			<input type="text" class="input2 wwx_f_l" name="lxdh" id="lxdh" validatelabel="联系电话" validate="require;maxlength(11)">
			<div class="wwx_clear"></div>
		</div>
		...
		<!-- <div class="margin1">
			...
			<textarea class="input2 wwx_f_l" style="resize:none;height: 120px;margin-top: 0px; margin-left: 10px;" name="xjnr" id="xjnr"></textarea>
			<div class="wwx_clear"></div>
		</div> -->
		...
		<div class="margin1">
		<script type="text/plain" id="myEditor" style="width:100%;height:50%;align:left;">
		...
		<!-- <div class="margin1">
			...
			<textarea class="input2 wwx_f_l" style="resize:none;height: 120px;margin-top: 0px; margin-left: 10px;" name="bz" id="bz"></textarea>
			<div class="wwx_clear"></div>
		</div> -->
		<div class="margin1">
			<div class="text1"></div>
