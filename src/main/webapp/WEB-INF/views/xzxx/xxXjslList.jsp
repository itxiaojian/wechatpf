...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/xzxx/xxXjsl.js"></script>
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="信件受理"><a
				href="<%=path%>/xzxx/XxXjxxb/xjslPage" target="content"
				onfocus="this.blur()"><span>信件受理</span></a></li>
		</ul>
	</div>
