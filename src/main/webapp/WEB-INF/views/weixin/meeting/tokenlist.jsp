...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/resources/js/ux/newdatetime/ux_datetimefile.js"></script>
    <script type="text/javascript" src="<%=path%>/resources/js/ux/tree/treeCombo.js"></script>
   ...
   <link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/icons.css" />  
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ux/zy/treeCombo.js"></script>
	<script type="text/javascript" src="<%=path%>/resources/js/ux/ST.ux.util.js"></script>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/token/tokenlist.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="保存微信token值"><a
				href="<%=path%>/wxutil/meeting/ownerpage" target="content"
				onfocus="this.blur()"><span>保存微信token值</span></a></li>
		</ul>
	</div>
