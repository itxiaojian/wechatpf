...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/meeting/ownerlist.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="会议管理"><a
				href="<%=path%>/wxutil/meeting/ownerpage" target="content"
				onfocus="this.blur()"><span>会议管理</span></a></li>
		</ul>
	</div>
