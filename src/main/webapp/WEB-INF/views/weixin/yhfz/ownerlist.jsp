...
<%--     <script type="text/javascript" src="<%=path%>/resources/js/ux/tree/treeCombo.js"></script> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/yhfz/ownerlist.js"></script>
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/yhfz/treeCombo.js"></script>
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="用户分组管理"><a
				href="<%=path%>/wxutil/yhfz/ownerpage" target="content"
