...
<%-- 	<script type="text/javascript" src="<%=path%>/resources/js/ux/zy/treeCombo.js"></script> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/weixin/twxx/twxxzt.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="图文消息"><a
				href="<%=path%>/weixin/twxx/twxxztPage" target="content"
				onfocus="this.blur()"><span>图文消息管理</span></a></li>
		</ul>
	</div>
