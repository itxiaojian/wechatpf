...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sys/sysLog.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/sys/SysLog/logPage" target="content" onfocus="this.blur()"><span>一系统日志</span></a>
	</li>
</ul>
</div>
