...
<body class="sticky-header" style="background: #eff1f5">
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=path%>/resources/newbootstrap/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=path%>/resources/newbootstrap/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=path%>/resources/newbootstrap/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=path%>/resources/newbootstrap/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<%=path%>/resources/newbootstrap/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="<%=path%>/resources/newbootstrap/images/photos/user2.png" alt=""/>
                                </a>
...
<!--easy pie chart-->
<script src="<%=path%>/resources/newbootstrap/js/easypiechart/jquery.easypiechart.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/easypiechart/easypiechart-init.js"></script>

<!--Sparkline Chart-->
<script src="<%=path%>/resources/newbootstrap/js/sparkline/jquery.sparkline.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/sparkline/sparkline-init.js"></script>

<!--icheck -->
<script src="<%=path%>/resources/newbootstrap/js/iCheck/jquery.icheck.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/icheck-init.js"></script>

<!-- jQuery Flot Chart-->
<script src="<%=path%>/resources/newbootstrap/js/flot-chart/jquery.flot.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/flot-chart/jquery.flot.tooltip.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/flot-chart/jquery.flot.resize.js"></script>


<!--Morris Chart-->
<script src="<%=path%>/resources/newbootstrap/js/morris-chart/morris.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/morris-chart/raphael-min.js"></script>

<!--Calendar-->
<script src="<%=path%>/resources/newbootstrap/js/calendar/clndr.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/calendar/evnt.calendar.init.js"></script>
<script src="<%=path%>/resources/newbootstrap/js/calendar/moment-2.2.1.js"></script>
