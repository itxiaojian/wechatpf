...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/sys/sysGjzgl.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="关键字管理"><a
				href="<%=path%>/sys/sysGjzgl/gjzglPage" target="content"
				onfocus="this.blur()"><span>关键字管理</span></a></li>
		</ul>
	</div>
