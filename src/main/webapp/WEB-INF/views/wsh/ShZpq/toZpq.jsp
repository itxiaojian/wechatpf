...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/shZpq.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	...
	<a href="<%=path%>/wzy/ZyDhhl/dhhlPage" target="content" onfocus="this.blur()"><span>照片墙管理</span></a>
	</li>
</ul>
</div>
