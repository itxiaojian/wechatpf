...
<div id="main" style="margin-top: 10%;">
   ...
   <div class="demo">
   		<c:if test="${str==0 || str=='error' }">
	   		<div id="code"><img alt="" src="<%=path%>/resources/images/djt.png" width="100%" height="10%"></div>
   		</c:if>
   		<c:if test="${str!=0 && str!='error' }">
	   		<div id="code"><img alt="" src="<%=path%>/resources/images/djt.png" width="100%" height="10%"></div>
   		</c:if>
   		<div class="controls" style="margin-top: 5%;">
			<input id="save_apply" class="btn btn-success" type="button" onclick="gbwy();" value="关闭">
		</div>
   </div>
