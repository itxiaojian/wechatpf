...
<DIV class="wrap-btn" style="width:100%;"><A class="btn btn-publish" style="width:100%;" href="<%=path%>/wsh/ZsSkkqb/toEsscAdd?openId=${openId}"><IMG 
...
<UL class="goods-list group" id="goods_list" style="padding-left: 0;">
	<li class="goods-box" style="width: 100%;padding-right: 0;">
	        <div class="goods-attr">
		        ...
		        <span style="margin-left: 16%;">上课时间</span>
		        <span style="float: right;margin-right: 0.5%;">操作</span>
		    </div>
	</li>
<c:forEach var="data" items="${list}" varStatus="obj">
	<li class="goods-box" style="width: 100%;padding-right: 0;">
	     <div class="goods-attr">
			<a href="<%=path%>/wsh/ZsSkkqjlb/toList?id=${data.id}&openId=${openId}">
		        <span class="goods-name" style="width: 50%;">
		        	${data.kcmc }
		        </span>
			</a>
		    <span style="margin-left: 15%;">${data.sksj }</span>
			<a href="<%=path%>/wsh/ZsSkkqb/toEwmPage?id=${data.id}&openId=${openId}" style="float: right;margin-right: 0.5%;">
		    	<span style="color: rgb(36, 177, 156);">生成二维码</span>
			</a>
		 </div>
	</li>
</c:forEach>
