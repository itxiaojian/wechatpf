...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/shTpzl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="投票专栏">
	<a href="<%=path%>/wsh/ShTpzl/tpzlPage" target="content" onfocus="this.blur()"><span>投票专栏</span></a>
	</li>
</ul>
</div>
