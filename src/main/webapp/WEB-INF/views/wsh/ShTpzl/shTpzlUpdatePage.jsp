...
<body>
	...
	<div class="panel panel-success">
		<div id="opinionDiv" class="panel-heading"><font color="red">*</font> 投票专栏修改:</div>
...
<!-- 				<input type="hidden" name="tpnr" id="tpnr"/> -->
				<input type="hidden" name="id" id="id" value="${map.id}"/>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 投票内容</span>
					<input type="text" class="form-control" placeholder="请输入投票内容"
						value="${map.tpnr }" name="tpnr"
						id="tpnr" />
				</div>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 结束时间</span>
					<input type="text" class="form-control" placeholder=""
					    onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
						value="${map.yjssj}" name="jssj"
						id="jssj" />
				</div>
				<br>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/wsh/ShTpzl/updateTpzl',   //默认是form的action， 如果申明，则会覆盖  
...
// 		document.getElementById("tpnr").value=UM.getEditor('myEditor').getContent();
// 		if(returnFlag) {
