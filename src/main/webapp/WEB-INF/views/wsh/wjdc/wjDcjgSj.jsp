...
<meta name="viewport" content="width=device-width,user-scalable=no, initial-scale=1"></meta>
	...
	<link href="<%=path%>/resources/js/wsh/public.css"
		rel="stylesheet"/>

		<link href="<%=path%>/resources/js/wsh/result.css"
			rel="stylesheet"/>
...
<body>
	...
	<div class="zon_v2 clear" style="width: 100%;">

		<!--top end-->

		<div class="wjContent" style="padding: 0 0 0 0px;width: 100%;">
...
<%-- 							</c:if> --%>
				...
				<div class="wjbbody" style="width: 100%;">
					...
					<div class="WJcontent" style="margin: 0 auto;width: 100%;">
						<div class="charthead">
							<div></div>
						</div>
						...
						<div id="question_content_${data.seq}" class="ques mtop">
							<div class="ansimg mtop">
								...
								<div class="showimg">
									...
									<div class="chartdiv" style="width: 100%; padding-left: 0px; padding-right: 0px;">
...
<%-- 											</c:if> --%>
												<iframe frameborder="0" src="<%=path%>/wsh/WjObject/toWjDcjgZzt?oid=${map.oid }&qseq=${data.seq}" style="width: 100%; height: 350px;"></iframe>
											</div>
