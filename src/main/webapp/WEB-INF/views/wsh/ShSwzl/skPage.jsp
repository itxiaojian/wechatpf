...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/skPage.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="拾卡管理">
	<a href="<%=path%>/wsh/ShSwzl/skPage" target="content" onfocus="this.blur()"><span>拾卡管理</span></a>
	</li>
</ul>
</div>
