...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/ShSwzl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="失物招领管理">
	<a href="<%=path%>/wsh/ShSwzl/index" target="content" onfocus="this.blur()"><span>失物招领管理</span></a>
	</li>
</ul>
</div>
</body>
