...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/shZttl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="专题讨论">
	<a href="<%=path%>/wzy/ZyXyxw/xyxwPage" target="content" onfocus="this.blur()"><span>专题讨论</span></a>
	</li>
</ul>
</div>
