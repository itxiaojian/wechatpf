...
<body>
	...
	<div class="panel panel-success">
		<div id="opinionDiv" class="panel-heading"><font color="red">*</font> 专题讨论发布:</div>
	      ...
	      <div id="meizzCalendarLayer" name="meizzCalendarLayer" style="position: absolute; z-index: 9999; width: 144px; height: 193px; display: none">
			...
			<form name="submitForm" id="optionForm" method="post"
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="请输入计划结束时间" 
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/wsh/ShZttl/saveZttl',   //默认是form的action， 如果申明，则会覆盖  
