...
<body style="overflow: auto;">
   <div class="main">
      <div  class="DYtop" >
               <img style="width:100%; "  src="<%=path%>/resources/img/wzy/top_02.png" />
               <div class="anniu">
       ...
       <div class="bottom">
             ...
             <div  style="font-size:100%;text-align:center;margin-top: -7px;"><%--  来源单位：${map.bmmc }&nbsp;&nbsp;&nbsp; --%>发布时间：<fmt:formatDate value="${map.fbsj }" type="date" dateStyle="medium"/></div>
             <div >
                 ${map.ztnr}
			</div>
       </div>
