...
<body>
	...
	<div class="panel panel-success">
		<div id="opinionDiv" class="panel-heading"><font color="red">*</font> 专题讨论修改:</div>
		 ...
		 <script language="Javascript" src="<%=path%>/resources/js/xzxx/Calendar.js" type="text/javascript"></script>
	      <div id="meizzCalendarLayer" name="meizzCalendarLayer" style="position: absolute; z-index: 9999; width: 144px; height: 193px; display: none">
			...
			<form name="submitForm" id="optionForm" method="post"
				...
				<input type="hidden" name="ztnr" id="ztnr"/>
				<input type="hidden" name="id" id="id" value="${map.id}"/>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 专题名称</span>
					<input type="text" class="form-control" placeholder="请输入专题名称"
						value="${map.ztmc}" name="ztmc"
						id="ztmc" />
				</div>
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 专题标题</span>
					<input type="text" class="form-control" placeholder="请输入专题标题"
						value="${map.ztbt}" name="ztbt"
						id="ztbt" />
				</div>
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 计划结束时间</span>
					<input  class="form-control" placeholder="请输入计划结束时间" 
					    onClick="WdatePicker({startDate:'%y-%M-%d 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
						value="${map.jssj}" name="jhjssj" 
						id="jhjssj" />
				</div>
				<br>
				<!--style给定宽度可以影响编辑器的最终宽度-->
				<script type="text/plain" id="myEditor" style="width:99%;height:20%;">
						${map.ztnr}
				</script>
				<br>
				<div align="center">
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',          //把服务器返回的内容放入id为output的元素中     
			   ...
			   url: url+'/wsh/ShZttl/updateZttl',   //默认是form的action， 如果申明，则会覆盖  
	...
	function agree() {
		...
		document.getElementById("ztnr").value=UM.getEditor('myEditor').getContent();
		if(returnFlag) {
