			...
			<div id="lidw${obj.count }" class="tclist">
				...
				<div class="tccontent" style="padding-left: 0px;">
				   <div class="zhanti_title">
        	          <img src="<%=path%>/resources/img/wzy/zttlbt.png" style="width:10%;"/>专题讨论
                   </div>
				   <h1 style="text-align:center; font-size:16px; margin-top:2%; color:#333; float:left; width:100%; margin-bottom:2%;border-bottom:1px #ccc solid;">${list.ztbt }</h1>
                   <h2 style="text-align:center; font-size:10px; margin-top:2%; color:#2991e6; float:left; width:100%; padding-bottom:2%;">发布者：${list.fbr }&nbsp;&nbsp;发布时间：${list.fbsj }</h2>
                   <p>${list.ztnr }</p>
				   <div class="tcbutton">
					</div>
					<c:if test="${list.zt==1 }">
					<div class="zhanti_title">
        	           <img src="<%=path%>/resources/img/wzy/wypl.png" width="35" height="35" style="margin-top:0;">我要评论
					...
					<div class="tcreply">
						<c:forEach items="${list.pllist}" var="pllist">
