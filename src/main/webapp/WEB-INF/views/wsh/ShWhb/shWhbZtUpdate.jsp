			...
			<div class="span12">
				<div class="right-content">
					...
					<section>
						...
						<form id="publish-form" action="<%=path%>/wsh/ShWhb/toEditWhb"
							method="post">
							<!--v-if-start-->
							<!--v-if-end-->
							...
							<label for="poster_name"> <span class="notify_import">*</span>
								...
								id="poster_name" class="poster_name" name="poster_name" value="${map.hbmc }"
							...
							<div class="poster_music">
								...
								&nbsp;&nbsp;&nbsp; <span id="music_name"
									style="font-size: 15px; opacity: 0.5;">${map.bz }</span>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
							...
							<div class="poster_input">
								<input type="button" value="创建海报" id="create_submit"
									...
									name="music_id" value="${map.bjyy }" type="hidden"> <input
									name="music_name" id="music_name_hidden" value="${map.bz }" type="hidden">
								<input name="fileName" id="fileName" value="${map.hbfm }" type="hidden">
								<input name="id" id="id" value="${map.id }" type="hidden">
