...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wsh/shJzbg.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="讲座报告">
	<a href="<%=path%>/wsh/ShJzbg/jzbgPage" target="content" onfocus="this.blur()"><span>讲座报告</span></a>
	</li>
</ul>
</div>
