...
/*离校流程*/
.WX_student_msg{ width:94%; border:1px solid #aaa; border-radius:10px; float:left; padding-bottom:5px; margin-left:3%}
...
.H_color{ color:#666;}
.fenlan{ width:100%; height:2px; background-color:#8bc0f2; float:left; margin-top:30px;}
</style>
...
function fanhui(openId) {
	/* alert(openId); */
    location.href="<%=path%>/wlx/ZsLxTx/getTxlist?openId="+openId;
}
...
<div class="phone_01">
		<div class="logo">
				...
				<div class="anniu" style="position: absolute; top:15%; left: 87%;width: 9%;">
