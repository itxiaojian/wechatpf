...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wlx/lxXgxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="离校相关信息">
	<a href="<%=path%>/wzy/ZyXyxgxx/xyxgxxPage" target="content" onfocus="this.blur()"><span>离校相关信息</span></a>
	</li>
</ul>
</div>
