...
<body onload="showECharts()">
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="在校学生统计"><a
				href="<%=path%>/stat/echarts/student" target="content"
				onfocus="this.blur()"><span>在校学生统计</span></a></li>
		</ul>
	</div>
	<div id="table"
		style="height:40%; border: 0px solid #ccc;maigin-bottom:0px;">
		<div>
