...
function sctp(){
	//alert(2);
	//var openId = ${openId};
	var bmmc1 = document.getElementById("bmmc");
	var bmmc = bmmc1.value;
	location.href="<%=path%>/stat/echarts/data2?bmmc="+bmmc;
}

function loadMore(page,bmmc){
	i=page;
	i++;
	var size = (i-1)*10;
	var url ="<%=path%>/stat/echarts/data1";
	var html= "";
    $.ajax({
		url :url,
		data : {
		...
		success : function(data) {
			...
			$('.zjgd').attr("onclick","loadMore('"+i+"','"+bmmc+"')");
			},
		   error : function() {
			alert("error");
		}
            ...
            <div class="container" style="margin-bottom:0px;">
                <div class="row">
                  <div class="col-sm-12" style=" border-bottom:1px solid #e5e5e5; height:40px;">
                    ...
                    <input type="text" style="width:40%;" id="bmmc">&nbsp;
            ...
            <table class="table table-striped" style=" margin-top:20px; text-align:center;">
             <tr>
                ...
                <td  style="position:relative;">
                    <a class="zjgd" href="javascript:;" onclick="loadMore('${pages}','${bmmc}');">
					加载更多信息
					</a>
				</td>
				</tr>
