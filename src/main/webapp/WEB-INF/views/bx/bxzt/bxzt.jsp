...
<div>
		<ul class="tab-menu tab" id="tabMenuID_">
			...
			<a href="<%=path%>/bx/bxzt/openBxztPage" target="content" onfocus="this.blur()"><span>报修主题</span>
			</a></li>
		</ul>
	</div>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/bx/bxzt/bxzt.js"></script>	
</body>
</html>
