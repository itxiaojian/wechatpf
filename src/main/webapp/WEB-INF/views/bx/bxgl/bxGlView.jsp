...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/bx/bxgl/bxgl.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="报修管理">
	<a href="<%=path%>/bx/bxgl/index" target="content" onfocus="this.blur()"><span>报修管理</span></a>
	</li>
</ul>
</div>
</body>
