				...
				<tbody>
				 <c:forEach var="data" items="${list}" varStatus="status">
					<tr>
						...
						<td style="width: 23%" class="tl"><span title="${data.bxbh}" class="bxbh" id="Label1">${data.bxbh}</span></td>
					...
					<tr>
						<td class="table_titles" style="height: 40px"><font>申报内容：</font></td>
						<td class="tl" colspan="5"><span class="nrtd" title="${data.nr}" id="Label11">${data.nr}</span></td>
					</tr>
					<tr>
						<td class="table_titles"><font>备注：</font></td>
						<td class="tl" colspan="5"><span class="bztd"  id="Label12"></span>
