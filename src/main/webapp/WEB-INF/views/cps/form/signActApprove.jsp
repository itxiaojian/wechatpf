	  ...
	  <div class="panel-body" >
			<form name="submitForm" id="optionForm" method="post">
				...
				<div class="row">
				  <div class="col-lg-6">
					 <div class="input-group">
					    <span class="input-group-addon"><font color="red">*</font>同意授信金额(万元)</span>
				  ...
				  <div class="col-lg-6">
					 <div class="input-group">
					    ...
					    <input type="text" class="form-control" placeholder="请输入同意利率浮动" value= "${mapBusi.creditRate}" name = "creditRate" id="creditRateInputId" />
					  </div>
				  </div>
				  <div class="col-lg-6">
					 <div class="input-group">
					    <span class="input-group-addon"><font color="red">*</font>同意授信年限(年)</span>
					    <input type="text" class="form-control" placeholder="请输入同意授信年限" value= "${mapBusi.creditYear}" name = "creditYear" id="creditYearInputId" />
					  </div>
				  </div>				  
				</div>		
				...
				<div align="center">
					...
					<input type="button" class="btn btn-primary" name="write_optionContent2" onClick="handwrite('${userCode}')" value="手写" />
					<!-- 
...
<script type="text/javascript">
	...
	function disagree() {
		try {
			...
			$("#valueInputId").val(0);
			$("#signDataID").val(signData);
			$("#creditRateInputId").val("");
			$("#creditYearInputId").val(0);
			$("#optionForm").ajaxForm(options); 
		} catch (e) {
				alert("控件没有安装，请刷新本页面。");
				return false;
	...
	function checkApproveData() {
		...
		if(newCreditSumW == null ||  newCreditRate == null  || newCreditYear == null
				|| newCreditSumW == "" ||  newCreditRate == ""  || newCreditYear == "") {
			returnFlag = false;
