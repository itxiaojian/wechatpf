...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>金农易贷·福农卡”贷款调查、审查、审批表</title>
...
<script type="text/javascript">
	...
	var options = {
			//   target: '#output',        //把服务器返回的内容放入id为output的元素中      
			   ...
			   url: '/cps/form/saveFormEasycard',                 //默认是form的action， 如果申明，则会覆盖  
...
<form class="form-table" id="optionForm" method="post">
	<div class="well" >
        <legend align="center">“金农易贷·福农卡”贷款调查、审查、审批表</legend>
        <table width="100%" border="1" align="center" cellspacing="0" >
            ...
            <tr class="title">
                ...
                <td class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="sharesAmount" class="{required:true,digits:true}" value="" style="width: 55%"/> </td>
                <td class="tdtitle">股权证编号:</td>
                <td class="inputtext"><input type="text" name="warrantsNo"  value="" style="width: 89%"/></td>
            </tr>
            <tr class="title">
            ...
            <tr class="title">
            	<td class="tdtitle"><span style="color:red">*</span> 资产总额:</td>
                <td colspan="3" class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="assets" class="{required:true,digits:true}" value="" style="width: 70%"/> </td>
                <td class="tdtitle"><span style="color:red">*</span> 负债总额:</td>
                <td  class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="debt" class="{required:true,digits:true}" value="" style="width: 55%"/> </td>
                <td class="tdtitle"><span style="color:red">*</span> 净资产:</td>
                <td class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="netAssets" class="{required:true,digits:true}" value="" style="width: 60%"/> </td>
            </tr>
            <tr class="title">
            	<td class="tdtitle"><span style="color:red">*</span> 上期授信额度:</td>
                <td colspan="3" class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="lastLineCredit" class="{required:true,digits:true}" value="" style="width: 70%"/> </td>
                <td class="tdtitle">信用状况:</td>
                <td  class="inputtext" colspan="3">
                   	<input type="radio" name="creditStatus" value="1" lang="1" checked="checked"/>无逾期
					<input type="radio" name="creditStatus" value="2" />逾期一次
					<input type="radio" name="creditStatus" value="3" />逾期多次 
                </td>
            </tr>
            <tr class="title">
            	<td class="tdtitle">开立结算户:</td>
                <td colspan="3" class="inputtext">
                	<input type="radio" name="openSettlement" value="1" checked="checked"/>是
					<input type="radio" name="openSettlement" value="2" />否 
				</td>
                <td class="tdtitle">开立网银:</td>
                <td  class="inputtext">
                	<input type="radio" name="openInternetBank" value="1" checked="checked"/>是
					<input type="radio" name="openInternetBank" value="2" />否 
                </td>
                <td class="tdtitle">开立短信通:</td>
                <td class="inputtext">
                	<input type="radio" name="openSms" value="1" checked="checked"/>是
					<input type="radio" name="openSms" value="2" />否
                </td>
            </tr>
            <tr class="title">
            	<td class="tdtitle"><span style="color:red">*</span> 近期平均存款:</td>
                <td colspan="3" class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="recentAverageDeposit" class="{required:true,digits:true}" value="" style="width: 70%"/> </td>
                <td class="tdtitle">以前年度贷款使用情况:</td>
                <td  class="inputtext" colspan="3">
                   	<input type="radio" name="annualLoanUseAgo" value="1" lang="1" checked="checked"/>按合同用途使用
					<input type="radio" name="annualLoanUseAgo" value="2" />未按合同用途使用
                </td>
            </tr>
