...
<script type="text/javascript">
	...
	var options = {
			//   target: '#output',        			//把服务器返回的内容放入id为output的元素中      
			   ...
			   url: '/cps/form/saveFormUnprofor', 	//默认是form的action， 如果申明，则会覆盖  
...
<form class="form-table" id="optionForm" method="post">
	<div class="well" >
        <legend align="center"> 企业联保贷款调查、审查、审批表 </legend>
        <table width="100%" border="1" align="center" cellspacing="0" >
            ...
            <tr class="title">
            	<td class="tdtitle">互助金存款账号:</td>
                <td colspan="3" class="inputtext"><input type="text" name="mutualNo" class="{maxlength:64}"  value="" style="width: 89%"/> </td>
                <td class="tdtitle"><span style="color:red">*</span> 存入互助金:</td>
                <td class="inputtext"><span class="input-group-addon">( 万元 )</span><input type="text" name="mutualAmount" class="{required:true,number:true,maxlength:10}" value="" style="width: 55%"/> </td>
                <td class="tdtitle">凭证号码:</td>
                <td class="inputtext"><input type="text" name="sharesAmount" class="{maxlength:32}"  value="" style="width: 89%"/></td>
            </tr>
