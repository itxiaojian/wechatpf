...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
  ...
  <body onload="showWebSign()">
	...
	<div class="panel panel-success">
	  <div id="opinionDiv" class="panel-heading"><span><font color="red">*</font> 填写贷款批复（请按照批复格式正确填写）: </span></div>
...
<script type="text/javascript">
	...
	var options = {  
			//   target: '#output',        //把服务器返回的内容放入id为output的元素中      
			   ...
			   url: '/cps/form/dealActMS',   //默认是form的action， 如果申明，则会覆盖  
