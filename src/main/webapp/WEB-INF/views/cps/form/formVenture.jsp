...
<script type="text/javascript">
	...
	var options = {
			//   target: '#output',        //把服务器返回的内容放入id为output的元素中      
			   ...
			   url: '/cps/form/saveFormVenture',                 //默认是form的action， 如果申明，则会覆盖  
...
<section class="info-section" id="info" data-title="XXXX<small>“创业乐”贷款调查、审查、审批表</small>" />
<form class="form-table" id="optionForm" method="post">
	<div class="well" >
        <legend align="center">“创业乐”贷款调查、审查、审批表</legend>
        <table width="100%" border="1" align="center" cellspacing="0" >
        	<tr class="title">
                ...
                <td width="14%" class="tdtitle">年龄:</td>
                <td width="14%" class="inputtext"><input type="text" name="custAge"  value="${map.age }" style="width: 100px"/></td>
            ...
            <tr class="title">
                ...
                <td class="tdtitle"><span style="color:red">*</span> 创业类型:</td>
                <td class="inputtext">
                	<select class="form-control input-sm" name="ventureType" >
						<option value="1" >创业青年</option>
						<option value="2" >创业民工</option>
						<option value="3" >创业大学生</option>
						<option value="4" >下岗在就业</option>
						<option value="5" >创业妇女</option>
					</select>
                </td>
                <td class="tdtitle">推荐单位:</td>
                <td class="inputtext"><input type="text" name="recommendedUnits" class="{maxlength:16}" value="" style="width: 89%"/></td>
            </tr>
            <tr class="title">
            	<td class="tdtitle"><span style="color:red">*</span> 创业项目:</td>
                <td colspan="8" class="inputtext"><input type="text" name="ventureProjects"  value="" class="{required:true,maxlength:16}" style="width: 97%"/></td>
            </tr>
            <tr class="title">
            	<td class="tdtitle">社保卡卡号:</td>
                <td colspan="3" class="inputtext">
                	<input type="text" name="socialSecurityCard" class="{maxlength:16}" value="" style="width: 89%"/>
				</td>
                <td class="tdtitle">相关部门是否推荐:</td>
                <td  class="inputtext">
                	<input type="radio" name="isRecommend" value="1" checked="checked"/>是
					<input type="radio" name="isRecommend" value="2" />否 
                </td>
                <td class="tdtitle">资料是否完备:</td>
                <td class="inputtext">
                	<input type="radio" name="isDataComplete" value="1" checked="checked"/>是
					<input type="radio" name="isDataComplete" value="2" />否
                </td>
            </tr>
