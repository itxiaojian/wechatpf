       ...
       <table class="table-striped table-bordered"  align="center" width="100%">
		...
		<c:forEach var="data" items="${infos}" varStatus="status"> 
				<tr>
					...
					<td>${data.RELATIONSHIP_CUSTOMER_ID }</td>
					<td>${data.UNIT_NAME }</td>
					<td align="center"><a href="javascript:void(0)" onclick="parent.showRelatedUnitInfoDetails('${data.ROW_ID}','${data.UNIT_NAME}')">查看</a></td>
				</tr>
			</c:forEach>
       </table>
      </form>
