...
<%-- 	<link rel="stylesheet" type="text/css" href="<%=path%>/resources/css/cps_icons.css" /> --%>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wfw/zsDzxq.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="周次学期配置">
	<a href="<%=path%>/wfw/dzxq/index" target="content" onfocus="this.blur()"><span>周次学期配置</span></a>
	</li>
</ul>
</div>
</body>
