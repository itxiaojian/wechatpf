...
function loadMore(page,openId,qh){
	i=page;
	i++;
	var url ="<%=path%>/wfw/ZsJxcg/toJxcgZj";
	var html= "";
    $.ajax({
		url :url,
		data : {
		...
		success : function(data) {
		    ...
		    html+="<div id='lidw"+i+"' class='maring1'>"
				...
				+"<tr class='odd-row'>"
			    +"<td class='first'>成果编号</td>"
			    +"<td class='last'>"+value.cgbh+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>成果名称</td>"
			    +"<td class='last'>"+value.cgmc+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>奖励类别</td>"
			    +"<td class='last'>"+value.lb+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>颁奖单位</td>"
			    +"<td class='last'>"+value.bm+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>完成人工号</td>"
			    +"<td class='last'>"+value.gh+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>完成人姓名</td>"
			    +"<td class='last'>"+value.xm+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>获奖时间</td>"
			    +"<td class='last'>"+value.hjsj+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>获奖年份</td>"
			    +"<td class='last'>"+value.zzjf+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
...
<div class="top_01">
		...
		<form action="<%=path%>/wfw/ZsJxcg/toJxcg" id="myForm" class="wwx_f_a"  method="post" style="display: inline;">
		...
		<span style="width:10%">
        	<a href="<%=path%>/wfw/zy/zhuye?openId=${openId}">
        		<img class="fanhui" src="<%=path%>/resources/img/wzy/fanhui.png" style="width:9%;margin-top: 1.5%;">
            </a>
        </span>
</div>
<div class="zhengwen">
