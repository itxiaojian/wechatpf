...
<body id="cardunion" class="mode_webapp2"
	style="background-color: white;padding-bottom: 0;" onload="wx.hideOptionMenu();">
<!-- 	style="background-color: white;padding-bottom: 0;" onload="ScrollDiv();"> -->
...
<div class="top_01">
		...
		<form action="<%=path%>/wfw/ZsPksxx/toPksxx" id="myForm" class="wwx_f_a"  method="post" style="display: inline;">
...
function loadMore(page,openId){
	i=page;
	i++;
	location.href ="<%=path%>/wfw/ZsPksxx/toPksxx?pages="+i+"&openId="+openId;
}
