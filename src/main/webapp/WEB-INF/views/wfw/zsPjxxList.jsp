...
function loadMore(page,openId){
	i=page;
	i++;
	var url ="<%=path%>/wfw/ZsPjxx/toPjxxZj";
	var html= "";
    $.ajax({
		url :url,
		data : {
		...
		success : function(data) {
		    ...
		    html+="<div id='lidw"+i+"' class='maring1'>"
			    ...
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>教师姓名</td>"
			    +"<td class='last'>"+value.jsxm+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>评教学年</td>"
			    +"<td class='last'>"+value.ksxn+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>评教学期</td>"
			    +"<td class='last'>"+value.ksxq+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>添加时间</td>"
			    +"<td class='last'>"+value.tjsj+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>状态</td>"
			    +"<td class='last'>"+value.ztmc+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    ...
			    +"<td class='last'>"
			    +"<a href='javascript:;' onclick='toMx("+value.id+","+value.zt+")'><span style='color:blue'>评价</span></a>"
			    +"</td>"
			    +"</tr>"
                +"</table>"
            	+"</div>"
...
<div class="top_01">
		...
		<form action="<%=path%>/wfw/ZsPjxx/toPjxx" id="myForm" class="wwx_f_a"  method="post" style="display: inline;">
