...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wfw/zsTxltj.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="通讯录">
	<a href="<%=path%>/wzy/ZyDhhl/dhhlPage" target="content" onfocus="this.blur()"><span>通讯录</span></a>
	</li>
</ul>
</div>
