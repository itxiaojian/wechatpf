					...
					<div class="content1">
						...
						<div class="er">
							<a href="#" onclick="jcbd('${openId}')"
								style="width:50px" class="img"> <img src="<%=path%>/resources/img/locked.png" />
								<p>解除绑定</p>
							</a>
						</div>
					</div>
	  ...
	  <li></li>
       ...
       <ul class="ul">
         <li class="li">
		   ...
		   <span class="xytz" style="float:left;">学生连续未上网提醒</span><br>
     <%-- <c:choose>
      <c:when test="${tshstxsl == 0}">
           <span class="xytz" style="float:left;">学生连续未上网提醒</span><br>
     </c:when>
     <c:otherwise>
           <span class="xytz" style="float:left;"><a href="#">
           			学生连续未上网提醒&nbsp;&nbsp;<img src="<%=path%>/resources/img/new.gif"/></a></span><br>
     </c:otherwise>
     </c:choose>   --%>       
           <span class="-list01-i-prefix mute"  ></span>
     <c:choose>
