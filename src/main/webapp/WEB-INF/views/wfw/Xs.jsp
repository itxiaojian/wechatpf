...
<body>
			...
			<!-- 第一页 -->
				<ul class="main">
					...
					<div class="content1">
						...
						<!-- 解除绑定-->
						<div class="yi">
							<a href="javascript:void(0)" onclick="jcbd('${openId}')"
								style="width:50px" class="img"> <img
    ...
    <ul class="section-btn">
      ...
      <c:when test="${xssktxsl == 0}">
           <span class="xytz" style="float:left;"><a href="<%=path%>/wtx/TxXssktx/totxXssktxList?openId=${openId}">上课提醒</a></span><br>
     </c:when>
     <c:otherwise>
            <span class="xytz" style="float:left;"><a href="<%=path%>/wtx/TxXssktx/totxXssktxList?openId=${openId}">
            		上课提醒&nbsp;&nbsp;<img src="<%=path%>/resources/img/new.gif"/></a></span><br>
     </c:otherwise>
      </c:choose>    
           <span class="-list01-i-prefix mute"  ></span>
     <c:choose>
