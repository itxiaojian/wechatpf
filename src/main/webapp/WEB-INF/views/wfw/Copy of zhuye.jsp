...
<body>
	...
	<div id="content">
		...
		<!-- 主要代码 End ================================ -->
		<%-- <input type="" name="openId" id="openId" value="${openId }"> --%>
	</div>
	...
	<div class="bottom1" style="height:175px;">
      ...
      <c:when test="${xssktxsl == 0}">
           <span class="xytz" style="float:left;"><a href="<%=path%>/wtx/TxXssktx/totxXssktxList?openId=${openId}">学生上课提醒</a></span><br>
     </c:when>
     <c:otherwise>
            <span class="xytz" style="float:left;"><a href="<%=path%>/wtx/TxXssktx/totxXssktxList?openId=${openId}">
            		学生上课提醒&nbsp;&nbsp;<img src="<%=path%>/resources/img/new.gif"/></a></span><br>
     </c:otherwise>
     </c:choose>
            <span class="-list01-i-prefix mute"  ></span>
	 <c:choose>
    ...
    <div class="bottom2">
       <div class="bottom-hd" >
         <img class="aaa" src="<%=path%>/resources/img/xiaoxi.png"></img><span class="xytz" style="float:left;">校长信箱</span>
          <a class="xytz" style="float:right;font-size: 12px"  href="<%=path%>/xzxx/XxXjxxb/toXzxxList?openId=${openId}"> 更多</a> 
       </div>
     <div class="bottom-bd">
       <ul class="ul">
         <li class="li">
         <c:forEach var="data" items="${xjxxb}">
           <span class="-list01-i-prefix mute"></span>
           <span class="xjxxb" style="float:left;"><a href='<%=path%>/xzxx/XxXjxxb/toXzxxDetail?id=
           ${data.id}&opendId=${openId}'>${data.xjbt }</a></span>
           <c:choose>
	...
	<div class="footer">
<div class="footer-bottom" data-role="none" style="width: 100%;font-size:100%;margin-top: 345px;">
    copyright 2015皖西学院
</div>
</div>
