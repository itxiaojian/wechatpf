...
function loadMore(page,openId){
	i=page;
	i++;
	var url ="<%=path%>/wfw/ZsXsdkxx/toXsdkxxZj";
	var html= "";
    $.ajax({
		url :url,
		data : {
		...
		success : function(data) {
		    ...
		    html+="<div id='lidw"+i+"' class='maring1'>"
			    ...
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>贷款类型</td>"
			    +"<td class='last'>"+value.dkmc+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
			    +"<td class='first'>还款日期</td>"
			    +"<td class='last'>"+value.hkrq+"</td>"
			    +"</tr>"
			    +"<tr class='odd-row'>"
			    +"<td class='first'>金额</td>"
			    +"<td class='last'>"+value.je+"</td>"
			    +"</tr>"
			    +"<tr class=''>"
...
<div class="top_01">
		...
		<form action="<%=path%>/wfw/ZsXsdkxx/toXsdkxx" id="myForm" class="wwx_f_a"  method="post" style="display: inline;">
