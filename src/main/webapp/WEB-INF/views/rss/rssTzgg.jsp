...
<script type="text/javascript" src="<%=path%>/resources/js/rss/rss_ttgg.js"></script>
<title>微主页</title>
<script type="text/javascript">
    path="<%=path%>";
    url_rss= "http://211.70.160.21/_wp3services/rssoffer?siteId=2&templateId=208&columnId=6";
</script>
	...
	<div class="phone">
		...
		<div class="main">
			...
			<div class="title_name"style="margin-top:-6px;">
				<span class="title_nametext">&nbsp;&nbsp;通知公告</span> 
