...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyCdptViewAll.js"></script>
...
<body style="background-color: #ffffff;">
	...
	<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="主页菜单配置"><a
				href="<%=path%>/sys/sysAdpz/adpzPage" target="content"
				onfocus="this.blur()"><span>主页菜单配置</span></a></li>
		</ul>
	</div>
