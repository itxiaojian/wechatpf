...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyLqxx.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="录取信息">
	<a href="<%=path%>/wzy/ZyLqxx/LqxxPage" target="content" onfocus="this.blur()"><span>录取信息</span></a>
	</li>
</ul>
</div>
