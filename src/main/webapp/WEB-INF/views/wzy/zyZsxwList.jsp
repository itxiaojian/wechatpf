...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/zyZsxw.js"></script>
...
<ul class="tab-menu tab" id="tabMenuID_">
	<li class="tab-selected" title="招生新闻">
	<a href="<%=path%>/wzy/ZyXyxw/xyxwPage" target="content" onfocus="this.blur()"><span>招生新闻发布</span></a>
	</li>
</ul>
</div>
