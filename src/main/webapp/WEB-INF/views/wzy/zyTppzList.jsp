...
<head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/wzy/ZyTppz.js"></script>
...
<div style="display: none;">
		<ul class="tab-menu tab" id="tabMenuID_">
			<li class="tab-selected" title="图片信息"><a
				href="<%=path%>/wzy/ZyLbt/index" target="content"
				onfocus="this.blur()"><span>图片信息</span></a></li>
		</ul>
	</div>
