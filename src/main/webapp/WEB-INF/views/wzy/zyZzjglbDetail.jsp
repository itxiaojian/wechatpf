...
<body style="overflow: auto;" id="zhuti" onload="wx.hideOptionMenu()">
	<div class="main">
		...
		<div class="bottom" style="border:0px;">
			<div class="tupian">
				<img src="<%=path%>/resources/img/zzjgBT.png" style="margin-top:2px;"/>
			</div>
			<div class="title_name" style="width: 100%;">
				<span class="title_nametext">&nbsp;&nbsp;组织机构</span> 
			...
			<div class="New_list">
				...
				<tr>
				            <a href="<%=path%>/wzy/ZyXyxgxx/zyXyxgxxDetail?id=${list.id}">${list.xwbt }</a> 
