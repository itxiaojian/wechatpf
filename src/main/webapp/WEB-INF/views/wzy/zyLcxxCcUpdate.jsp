...
function close(){
  ...
  function save(){
	...
	var url="";
	var msg="";
		url="<%=path%>/wzy/ZyLcxx/updateCcxx";
		msg="确定要提交申请信息吗？";
	if (confirm(msg)) {
		//getMrjh();
		$.ajax({
			...
			success : function(data) {
				if(data=='1'){
					alert('保存成功！'); 
					location.href="<%=path%>/wzy/ZyXyxw/toCcjl?openId="+openId;
				}else{
					alert("保存失败，请联系管理员。");
					return false;
				}
           ...
           <input id="endtime" name="endtime" 
            ...
            <p class="help-block"></p>
	           ...
	           <label class="control-label" for="input01">审核人:</label>
	          	<div class="controls">
		            <select id="shrSel"  onchange="getShr(this.value)" style="width:252px;height:30px;margin-left:2px;">
