...
<body>
	...
	<div class="panel panel-success">
		<div id="opinionDiv" class="panel-heading"><font color="red">*</font> 招生新闻发布:</div>
		<div class="panel-body">
			<form name="submitForm" id="optionForm" method="post"
				...
				<br>
				<div class="input-group">
					<span class="input-group-addon"><font color="red">*</font> 排序</span>
					<select class="form-control input-sm" name="px" value="" >
