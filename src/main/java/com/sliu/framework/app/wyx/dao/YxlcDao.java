...
@Repository
public class YxlcDao extends HibernateBaseDaoImpl<SysWxyh, String>{
	...
	public List<Map<String,Object>> getGrlx(String openId){
		...
		String sql= "SELECT b.tacheid,a.stuid,a.stuname,a.xsyx,a.xszy,a.blzt,b.tachename,c.dd"
                    +" FROM zs_yx_tache b LEFT JOIN zs_yx_tachestatus a ON b.tacheid = a.tacheid"
                    +" LEFT JOIN zs_yx_zdxx c ON c.tacheid = a.tacheid "
	...
	public List<Map<String,Object>> getGrlx1(String openId){
		...
		String sql= 
				...
				+"SELECT a.tacheid,'"+stuid+"' AS stuid,'"+stuname+"'  as stuname,'"+xsyx+"' as xsyx,'"+xszy+"' as xszy ,"
			  	+" b.blzt,a.tachename,b.dd FROM zs_yx_tache a LEFT JOIN "
			     ...
			     +"   WHERE b.stuid IS NULL)a,zs_yx_zdxx b"
	...
	public List<Map<String, Object>> getGrxx(String stuid){
		...
		String sql =" SELECT stuid,stuname,xsyx,xszy FROM  zs_yx_tachestatus where 1=1   "+str+"  GROUP BY  stuid  ";
...
/**
	...
	public List<Map<String,Object>> getGrlxxx(int tacheid,String openId){
		...
		String sql="select  a.tacheid,a.stuid,a.stuname,a.xsyx,a.xszy,a.blzt,a.reason,b.sj,b.dd,b.zysx,c.tachename from zs_yx_tachestatus a"
				+ " left join zs_yx_zdxx b on b.tacheid=a.tacheid left join zs_yx_tache c on c.tacheid = a.tacheid where 1=1  and a.tacheid = '"+tacheid+"' and a.stuid = '"+str+"'";
		return jdbcTemplate.queryForList(sql);
	}
