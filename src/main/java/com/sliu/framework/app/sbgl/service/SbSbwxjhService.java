...
import com.sliu.framework.app.sbgl.dao.SbSbwxjhDao;
import com.sliu.framework.app.sbgl.model.SbSbjyjh;
import com.sliu.framework.app.sbgl.model.SbSbwxjh;


@Service
public class SbSbwxjhService extends BaseBO<SbSbjyjh> {

	@Autowired
	private SbSbwxjhDao dao;
	...
	public Pagination<Map<String, Object>> getSbwxjhList(Integer start, Integer limit,String wxjh,String wxjb,String sblb){
		...
		return dao.getSbwxjhList(start, limit,wxjh,wxjb,sblb);
	 ...
	 */
	@Transactional
	public String save(SbSbwxjh entity) {
		if("1".equals(entity.getXhfs())){
			Date date=entity.getScwxsj();
			Calendar calendar = Calendar.getInstance();
	    	calendar.setTime(date);
	    	calendar.add(Calendar.MONTH, entity.getJg());
	    	date = calendar.getTime();
			entity.setXcwxsj(date);
		}else{
			entity.setJg(null);
		}
		dao.save(entity);
	 ...
	 */
	@Transactional
	public void update(SbSbwxjh entity,String id){
	...
	public void updateWc(String id, String zt, String gzms) {
		SbSbwxjh entity=dao.get(Long.parseLong(id));
