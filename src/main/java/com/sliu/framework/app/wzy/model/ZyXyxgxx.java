 ...
 * 主页--学院相关信息
 * @author duanpeijun
 * @version 创建时间：2015年6月3日  下午3:48:00
 */
@Entity
@Table(name = "ZY_XYXGXX")
public class ZyXyxgxx  implements Serializable{
	...
	@Column(name = "xwbt", length = 50, nullable = true)
	...
	@Column(name = "xwnr", nullable = false)
