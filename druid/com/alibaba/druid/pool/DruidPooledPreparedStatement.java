 ...
 */
public class DruidPooledPreparedStatement extends DruidPooledStatement
	...
	public ResultSet executeQuery() throws SQLException {
		...
		System.out
				.println("DruidPooledPreparedStatement==========================================");
		...
		if (params.size() != 0) {
			...
			for (int i = 1; i <= params.size(); i++) {
				if (params.get(i) != null
						&& (params.get(i) instanceof String || params.get(i) instanceof Date)) {
		...
		try {
			...
			DruidPooledResultSet poolableResultSet = new DruidPooledResultSet(
					this, rs);
	...
	public static class PreparedStatementKey {
		...
		public PreparedStatementKey(String sql, String catalog,
				MethodType methodType) throws SQLException {
			this(sql, catalog, methodType, 0, 0, 0, 0, null, null);
		}

		public PreparedStatementKey(String sql, String catalog,
				MethodType methodType, int resultSetType,
		...
		public PreparedStatementKey(String sql, String catalog,
				MethodType methodType, int autoGeneratedKeys)
				throws SQLException {
			this(sql, catalog, methodType, 0, 0, 0, autoGeneratedKeys, null,
					null);
		}

		public PreparedStatementKey(String sql, String catalog,
				MethodType methodType, int[] columnIndexes) throws SQLException {
			this(sql, catalog, methodType, 0, 0, 0, 0, columnIndexes, null);
		}

		public PreparedStatementKey(String sql, String catalog,
				MethodType methodType, String[] columnNames)
				throws SQLException {
